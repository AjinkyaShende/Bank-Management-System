...
public class Pin extends JFrame implements ActionListener {
    ...
    Pin(String pinnumber) {
        ...
        l1.setBounds(280, 120, 400, 35);
        l4.add(l1);

        l2.setBounds(220, 160, 150, 35);
        l4.add(l2);

        l3.setBounds(220, 205, 200, 35);
        l4.add(l3);

        t1.setBounds(350, 165, 150, 25);
        l4.add(t1);

        t2.setBounds(400, 205, 150, 25);
        l4.add(t2);
